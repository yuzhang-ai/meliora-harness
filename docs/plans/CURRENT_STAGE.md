...
| M0 真实纵向集成 | 你 + Codex | In progress | Issue #15；WP-1/2 已经 PR #16/#19 合并，WP-3A 已经 PR #20 合并至 main `17f54dd1`，WP-3B.1a 已由 PR #21 合并至 main `80bfbf1f`，WP-3B.1b 已由 PR #22 合并至 main `f72d2674`，WP-3B.2a 已由 PR #23 合并至 main `77fbf95a`，B2b.1 已由 PR #24 合并至 main `1055f7f8`；B2b.2 正在隔离分支施工：Receipt/公开 alias event 的原子 binding、principal-scoped SSE/cursor exact event gate 与安全恢复收口。不含 HTTP artifact route、public snapshot、retention/reset、Web live、非 loopback 登录或任意 artifact 扩展。 |
...
Contract-first slice、只读 Runtime、Store/Server skeleton、Provider Transport、durable command、Server composition、纵向 fake Provider fixture、Recovery Read Contract、fixture-first Web Shell、WP-3B.1a、WP-3B.1b、WP-3B.2a 与 B2b.1 已合并到 `main`。当前隔离施工 B2b.2：接入 matching Receipt/principal gate、Runtime/Server public alias 的原子 binding 与安全恢复收口；随后再推进 public resume snapshot、C recovery coordinator 与 SSE reset/restart。B2/C 尚未完成。
