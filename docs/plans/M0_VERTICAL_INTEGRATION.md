...
#### WP-3B.1a：private recovery primitives（已合并）
...
- PR #21 已合并到 `main@80bfbf1f`；B1b 负责 Runtime atomic cutover 与 `commitReceipt` 行为收紧，仍不包含 recovery coordinator、public snapshot 或 SSE reset。
